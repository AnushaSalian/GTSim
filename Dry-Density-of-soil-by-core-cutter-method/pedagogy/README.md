...
:--|:--|:--|:--|:--
1.| Student will be able to define Biological Oxygen Demand (BOD) and Dissolved Oxygen (DO) | Click on the button to display the definition of Biological Oxygen Demand | Q1) BOD is an important measure of _____. <br>A. An organisms natural level of oxygen requirements <br>B. Oxygen content of water and waste water <br>C. The oxygen using potential of water and waste water <br>D. <u>A measure of biological activity of water and waste water</u> |
2.| Student will be able to analyse the effect of MnSO<sub>4</sub> solution and Alkali-iodide-azide solution on the sample | Click on the beaker with the MnSO<sub>4</sub> solution and bottle with Alkali-iodide-azide solution to observe the changes | Q1) In the BOD analysis, the principle is to <br>A. <u> Measure the biodegradability of the sample</u> <br>B. Measure the toxicity of the sample <br>C. Both a and b <br>D. Neither a nor b |
3.| Student will be able to analyse the colour change when starch is added to the sample | Click on the bottle containing starch to observe the changes in the sample | Q1) What is the colour change during titration with Na<sub>2</sub>S<sub>2</sub>O<sub>3</sub> before adding starch? <br>A. Dark yellow to green <br> B. <u>Dark yellow to pale yellow</u> <br> C. Green to pale yellow <br>D. None of the above |
4.| Student will be able to calculate the values of DO and BOD for the given sample | Click on the button to see the formula used to calculate the required results | Q1) Initial DO is 6.5mg/l and final DO is 4.8mg/l, if dilution is 100 then BOD in mg/l <br>A. 150 <br>B. 210 <br>C. 140 <br>D. <u>170</u> |
5.| Student will be able to analyse BOD data in terms of organic matter as well as the amount of oxygen used during its oxidation | Click on the button to see the data obtained and analyse it | Q1) In a treatment plant when the influent BOD is 195mg/l and the effluent BOD is 25mg/l, then the percentage of BOD removed is <br>A. 91.18 <br>B. 82.25 <br>C. 74.25 <br>D. <u>87.18</u> |
...
2.| Click on the bottle-containing water sample to open its lid, take the sample in cylinder, and transfer 200ml each of the sample into two BOD bottle, then dilute the sample by adding distilled water to it, then label both the BOD bottles as Sample A and Sample B | Display take 200ml of sample in 2 BOD bottle and dilute it with dilution water by filling the bottle up to the neck | To provide basic environment to start the experiment
3.| Click on the automatic pipette, take 1ml of MnSO<sub>4</sub> solution from the beaker, and add it to BOD bottle containing Sample A | Display add 1ml of MnSO<sub>4</sub> solution to Sample-A bottle | To add MnSO<sub>4</sub> solution
4.| Click on the automatic pipette, take 1ml of Alkali-iodide-azide solution from the beaker, and add it to BOD bottle containing Sample A | Display add 1ml of Alkali-iodide-azide solution to Sample-A bottle | To add Alkali-iodide-azide solution
